...
public class NonBioForm extends AppCompatActivity implements
        AdapterView.OnItemSelectedListener  {
    String[] types = { "Electronic Item", "Plastic Waste", "Glass Waste", "Polythene", "Other"};
    Button submit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_bio_form);
        ...
        uploadImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ImagePicker.Companion.with(NonBioForm.this)
                        .galleryOnly()
                        .cropSquare()
...
//                    .maxResultSize(1080, 1080)	//Final image resolution will be less than 1080 x 1080(Optional)
        ...
        location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(ActivityCompat.checkSelfPermission(NonBioForm.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                    fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            ...
                            if(location!=null){
                                try {
                                    Geocoder geocoder=new Geocoder(NonBioForm.this, Locale.getDefault());
                    ...
                    ActivityCompat.requestPermissions(NonBioForm.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},44);
                }
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (address.getText().toString().isEmpty())
                    ...
                    Toast.makeText(NonBioForm.this, "Please Upload Waste Image", Toast.LENGTH_SHORT).show();
                else {
                    hideUI();
                                    ...
                                    rf.child(userId).addValueEventListener(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            if(user!=null)
                                            {
                                                ...
                                                showUI();
                                                startActivity(new Intent(NonBioForm.this,OrganicRequestHistory.class));
                                            }
                                        }
    ...
    private void SendRequest(OrganicWaste request)
    {
        ...
        DatabaseReference reference =firebaseDatabase.getReference("InorganicRequest").push();
        ...
        reference.setValue(request).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(NonBioForm.this,"Request Send Successfully", Toast.LENGTH_SHORT).show();
                ProgressBar progressBar = (ProgressBar)findViewById(R.id.spin_kit);
                progressBar.setVisibility(View.GONE);
