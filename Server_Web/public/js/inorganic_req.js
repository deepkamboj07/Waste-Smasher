...
const dbRef = ref(getDatabase());
    get(child(dbRef, 'InorganicRequest/')).then((snapshot) => {
    if (snapshot.exists()) {
        ...
        for (const key in data) {
            ...
            progress.addEventListener("click",function(){
                 set(ref(database, 'InorganicRequest/' + progress.value), {
            ...
            btnDelete.addEventListener("click", function() {
                remove(ref(database, 'InorganicRequest/' + btnDelete.value));
                location.reload();
            }, false);
            ...
            btnComp.addEventListener("click", function() {
                set(ref(database, 'InorganicRequest/' + btnComp.value), {
